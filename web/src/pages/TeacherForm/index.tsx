...
function TeacherForm(){
  ...
  return (
    <div id="page-teacher-form" className="container">
      ...
      description="O primeiro passo é preecher o formúlario de inscrição"
      />
      ...
      <main>
        ...
        <fieldset>
          ...
          />
          <Input name="cost" label="Custo da sua hora por aula" type="number"  value={cost}
            onChange={ (e) => { setCost(e.target.value) } }/>
        </fieldset>

        <fieldset>
          <legend>Hórarios disponíveis
             <button type="button" onClick={addNewScheduleItem}>+ Novo Hórario</button>
          </legend>
